...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uid', models.CharField(default='X2B6BcDVXNbCHo1svFqlGmBpMWl1', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followers', to='rareapi.user')),
            ],
        ),
        migrations.CreateModel(
            name='PostTags',
