...
from rareapi.views import register_user, check_user, ReactionView, CommentView, PostReactionView, PostView, TagsView, UserView, CategoryView, PostTagsView, SubscriptionView
...
router.register(r'posttags', PostTagsView, 'posttag')
